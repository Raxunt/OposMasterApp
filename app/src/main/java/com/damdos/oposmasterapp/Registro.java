...
import com.damdos.oposmasterapp.model.Usuario;
...
public class Registro extends AppCompatActivity {
    ...
    ImageView img;
    Spinner spinnerCuerpo, spinnerEspecialidad;
    private FirebaseAuth firebaseAuth;
    boolean cuerpoSeleccionado = false;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img.setImageResource(R.drawable.agenda);
        spinnerCuerpo = findViewById(R.id.spinner_cuerpo);
        spinnerEspecialidad = findViewById(R.id.spinner_especialidad);

        spinnerEspecialidad.setEnabled(false);

        spinnerCuerpo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selectedCuerpo = parent.getItemAtPosition(position).toString();

                if (selectedCuerpo.equals(getString(R.string.cuerpos_prompt))) {
                    cuerpoSeleccionado = false;
                    spinnerEspecialidad.setEnabled(false);
                } else {
                    cuerpoSeleccionado = true;
                    spinnerEspecialidad.setEnabled(true);

                    ArrayAdapter<String> especialidadAdapter;

                    if (selectedCuerpo.equals(getString(R.string.cuerpo_secundaria))) {
                        especialidadAdapter = new ArrayAdapter<>(Registro.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.especialidades_secundaria_opciones));
                    } else if (selectedCuerpo.equals(getString(R.string.cuerpo_fp))) {
                        especialidadAdapter = new ArrayAdapter<>(Registro.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.especialidades_fp_opciones));
                    } else {
                        return;
                    }
        ...
        boton_cancelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Registro.this, "Regresando al inicio de sesión", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void usuarioRegistrado(String nombreUsuario, String correoUsuario, String passwordUsiario) {
        String cuerpoSeleccionado = spinnerCuerpo.getSelectedItem().toString();
        String especialidadSeleccionada = spinnerEspecialidad.getSelectedItem().toString();
        firebaseAuth.createUserWithEmailAndPassword(correoUsuario, passwordUsiario).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                new FirebaseDatabaseHelper().agregarTemas(getListaTemas(cuerpoSeleccionado, especialidadSeleccionada), new FirebaseDatabaseHelper.DataStatus() {
                    @Override
                ...
                finish();
                startActivity(new Intent(Registro.this, Temario.class));
    ...
    private List<Tema> getListaTemas(String cuerpoSeleccionado, String especialidadSeleccionada) {
        List<Tema> listaTemas = new ArrayList<>();


        if (cuerpoSeleccionado.equals(getString(R.string.cuerpo_secundaria))) {

            if (especialidadSeleccionada.equals(getString(R.string.especialidad_musica))) {
                listaTemas = getTemasMusica();
            } else if (especialidadSeleccionada.equals(getString(R.string.especialidad_informatica))) {
                listaTemas = getTemasInformatica();
            }
        }
        if(cuerpoSeleccionado.equals(getString(R.string.cuerpo_fp))) {
            if (especialidadSeleccionada.equals(getString(R.string.especialidad_sistemas))) {
                listaTemas = getTemasSistemas();
            } else if (especialidadSeleccionada.equals(getString(R.string.especialidad_elec))) {
                listaTemas = getTemasElec();
    ...
    public ArrayList<Tema> getTemasMusica() {
        ArrayList<Tema> temas_musica = new ArrayList<>();
        ...
        temas_musica.add(new Tema(70, "Métodos y sistemas didácticos actuales de educación musical: Orff, Kodály, Willems, etc."));
        temas_musica.add(new Tema(71, "La educación musical en España. Legislación y situación actual."));

        return temas_musica;
    }

    public ArrayList<Tema> getTemasInformatica() {
        ArrayList<Tema> temas_informatica = new ArrayList<>();
        ...
        return temas_informatica;
    }


    public ArrayList<Tema> getTemasSistemas() {
        ArrayList<Tema> temas_sistemas = new ArrayList<>();
        ...
        return temas_sistemas;
    }

    public ArrayList<Tema> getTemasElec() {
        ArrayList<Tema> temas_elec = new ArrayList<>();
